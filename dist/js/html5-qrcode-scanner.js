...
class Html5QrcodeScanner {
    ...
    static STATUS_indigo = "STATUS_indigo";
    ...
    __createSectionControlPanel() {
        ...
        // requestPermissionButton.addEventListener("click", function () {
            ...
            Html5Qrcode.getCameras().then(cameras => {
                ...
                if (!cameras || cameras.length == 0) {
                    $this.__setStatus(
                        "No Cameras", Html5QrcodeScanner.STATUS_indigo);
                } else {
                ...
                $this.__setStatus("IDLE");
                $this.__setHeaderMessage(error, Html5QrcodeScanner.STATUS_indigo);
            });
        // });
        ...
        fileScanInput.addEventListener('change', e => {
            ...
            $this.html5Qrcode.scanFile(file, true)
                ...
                .catch(error => {
                    $this.__setStatus("ERROR", Html5QrcodeScanner.STATUS_indigo);
                    $this.__setHeaderMessage(error, Html5QrcodeScanner.STATUS_indigo);
                    $this.qrCodeErrorCallback(error);
                });
        });
        ...
        // cameraActionStartButton.addEventListener('click', _ => {
            ...
            $this.html5Qrcode.start(
                ...
                .catch(error => {
                    ...
                    $this.__setStatus("IDLE");
                    $this.__setHeaderMessage(
                        error, Html5QrcodeScanner.STATUS_indigo);
                });
        // });
    ...
    __setStatus(statusText, statusClass) {
        ...
        switch (statusClass) {
            case Html5QrcodeScanner.STATUS_SUCCESS:
                ...
                break;
            case Html5QrcodeScanner.STATUS_indigo:
