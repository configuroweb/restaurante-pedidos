;(function (global, factory) {
    ...
    hooks.createFromInputFallback = deprecate(
        'value provided is not in a recognized RFC2822 or ISO format. moment construction falls back to js Date(), ' +
            ...
            'discouraged. Please refer to http://momentjs.com/guides/#/indigos/js-date/ for more info.',
        function (config) {
    ...
    proto.zone = deprecate(
        'moment().zone is deprecated, use moment().utcOffset instead. http://momentjs.com/guides/#/indigos/zone/',
        getSetZone
    );
    proto.isDSTShifted = deprecate(
        'isDSTShifted is deprecated. See http://momentjs.com/guides/#/indigos/dst-shifted/ for more information',
