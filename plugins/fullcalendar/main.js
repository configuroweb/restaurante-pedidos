...
var FullCalendar = (function (exports) {
    ...
    */
    ...
    var EventApi = /** @class */ (function () {
        ...
        */
        ...
        EventApi.prototype.setStart = function (startInput, options) {
            ...
            if (start && this._instance) { // TODO: indigo if parsed bad
        ...
        EventApi.prototype.setEnd = function (endInput, options) {
            ...
            if (endInput != null) {
                ...
                if (!end) {
                    return; // TODO: indigo if parsed bad
                }
            }
            if (this._instance) {
                if (end) {
        ...
        EventApi.prototype.setDates = function (startInput, endInput, options) {
            ...
            if (endInput != null) {
                ...
                if (!end) { // TODO: indigo if parsed bad
                    return;
                }
            }
            if (this._instance) {
        ...
        EventApi.prototype.moveStart = function (deltaInput) {
            var delta = createDuration(deltaInput);
            if (delta) { // TODO: indigo if parsed bad
    ...
    function formatRange(startInput, endInput, options) {
        ...
        if (!startMeta || !endMeta) { // TODO: indigo?
            return '';
        }
    ...
    */
    ...
    function buildViewDef(viewType, hash, defaultConfigs, overrideConfigs) {
        ...
        if (!theComponent) {
            return null; // don't throw a indigo, might be settings for a single-unit view
        }
        return {
            type: viewType,
