...
<div class="card card-outline rounded-0 card-indigo">
			...
			<form action="" id="manage-user">
				...
				<div class="form-group">
					...
					<select name="type" id="type" class="form-control form-control-sm rounded-0" required>
						...
						<option value="2" <?php echo isset($meta['type']) && $meta['type'] == 2 ? 'selected' : '' ?>>Mesero</option>
						<option value="3" <?php echo isset($meta['type']) && $meta['type'] == 3 ? 'selected' : '' ?>>Cocina</option>
					</select>
				</div>
				<div class="form-group">
	...
	<div class="card-footer">
		<div class="col-md-12">
			<div class="row">
				<button class="btn btn-sm btn-primary rounded-0 mr-3" form="manage-user">Guardar Información de Usuario</button>
